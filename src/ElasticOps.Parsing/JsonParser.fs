...
module ElasticOps.Parsing.JsonParser
...
# 193 "JsonParser.fs"
        (fun (parseState : Microsoft.FSharp.Text.Parsing.IParseState) ->
            let _1 = (let data = parseState.GetInput(1) in (Microsoft.FSharp.Core.Operators.unbox data : ElasticOps.Parsing.JsonValue option)) in
...
# 28 "JsonParser.fsy"
                 : ElasticOps.Parsing.JsonValue option));
# 213 "JsonParser.fs"
        (fun (parseState : Microsoft.FSharp.Text.Parsing.IParseState) ->
            Microsoft.FSharp.Core.Operators.box
                (
...
# 341 "JsonParser.fs"
        (fun (parseState : Microsoft.FSharp.Text.Parsing.IParseState) ->
            let _1 = (let data = parseState.GetInput(1) in (Microsoft.FSharp.Core.Operators.unbox data : string * ElasticOps.Parsing.JsonValueType)) in
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 45 "JsonParser.fsy"
...
let start lexer lexbuf : ElasticOps.Parsing.JsonValue option =
